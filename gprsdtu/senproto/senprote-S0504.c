...
int S0504_prepare(void *buff, uint16_t addr)
{
    framebuff_t fb;
...
int S0504_parse(uint32_t senid, void *strbuf, void *datbuf, uint32_t size)
{
...
struct senproto_struct S0504_senproto = {S0504_prepare, S0504_parse};