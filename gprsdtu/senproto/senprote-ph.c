...
int ph_prepare(void *buff, uint16_t addr)
{
    framebuff_t fb;
...
int ph_parse(uint32_t senid, void *strbuf, void *datbuf, uint32_t size)
{
...
struct senproto_struct ph_senproto = {ph_prepare, ph_parse};