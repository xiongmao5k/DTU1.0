...
int water_prepare(void *buff, uint16_t addr)
{
    framebuff_t fb;
...
int water_parse(uint32_t senid, void *strbuf, void *datbuf, uint32_t size)
{
...
struct senproto_struct water_senproto = {water_prepare, water_parse};