...
int t800_prepare(void *buff, uint16_t addr)
{
    framebuff_t fb;
...
int t800_parse(uint32_t senid, void *strbuf, void *datbuf, uint32_t size)
{
...
struct senproto_struct t800_senproto = {t800_prepare, t800_parse};