///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.40.3.8902/W32 for ARM       25/Dec/2017  16:03:40
...
SPIFFS_format:
        ...
        MOVS     R4,R0
        LDR      R0,[R4, #+108]
        LDR.W    R1,??DataTable9  ;; 0x20090315
        CMP      R0,R1
        BEQ.N    ??SPIFFS_format_0
        LDR.W    R0,??DataTable9_1  ;; 0xffffd8d8
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable9_1  ;; 0xffffd8d8
        B.N      ??SPIFFS_format_1
??SPIFFS_format_0:
        ...
        LDR.W    R0,??DataTable9_2  ;; 0xffffd8d6
        STR      R0,[R4, #+52]
        MOVS     R0,#-1
        B.N      ??SPIFFS_format_1
??SPIFFS_format_2:
...
??SPIFFS_format_3:
        ...
        MOVS     R5,R0
        CMP      R5,#+0
        BEQ.N    ??SPIFFS_format_5
        LDR.W    R0,??DataTable10  ;; 0xffffd8d5
        MOVS     R5,R0
??SPIFFS_format_5:
        CMP      R5,#+0
        BPL.N    ??SPIFFS_format_6
        STR      R5,[R4, #+52]
        MOVS     R0,R5
        B.N      ??SPIFFS_format_1
??SPIFFS_format_6:
...
??SPIFFS_mount_4:
        ...
        B.N      ??SPIFFS_mount_6
??SPIFFS_mount_5:
        LDR.W    R0,??DataTable9  ;; 0x20090315
        STR      R0,[R4, #+108]
        MOVS     R0,R4
...
??SPIFFS_creat_0:
        ...
        LDR.W    R0,??DataTable11  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable11  ;; 0xffffd8f0
        B.N      ??SPIFFS_creat_1
??SPIFFS_creat_2:
        ...
        LDR.W    R0,??DataTable12  ;; 0xffffd8cc
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable12  ;; 0xffffd8cc
        B.N      ??SPIFFS_creat_1
??SPIFFS_creat_3:
...
??SPIFFS_open_5:
        ...
        CMP      R0,#+68
        BNE.N    ??SPIFFS_open_7
        LDR.W    R0,??DataTable13  ;; 0xffffd8d2
        MOV      R8,R0
        LDR      R0,[SP, #+8]
        LDRSH    R1,[R0, #+4]
        MOVS     R0,R4
...
??SPIFFS_open_7:
        LSLS     R0,R6,#+29
        BPL.N    ??SPIFFS_open_8
        LDR.W    R0,??DataTable14  ;; 0xffffd8ee
        CMP      R8,R0
        BNE.N    ??SPIFFS_open_8
        MOVS     R2,#+0
        ADD      R1,SP,#+14
...
??SPIFFS_open_by_page_3:
        ...
        LDR.W    R0,??DataTable17  ;; 0xffffd8d1
        MOV      R8,R0
        LDR      R0,[SP, #+4]
        LDRSH    R1,[R0, #+4]
        MOVS     R0,R4
...
??SPIFFS_open_by_page_4:
        ...
        BL       spiffs_object_open_by_page
        MOV      R8,R0
        LDR.W    R0,??DataTable16  ;; 0xffffd8e4
        CMP      R8,R0
        BEQ.N    ??SPIFFS_open_by_page_5
        LDR.W    R0,??DataTable16_1  ;; 0xffffd8ec
        CMP      R8,R0
        BEQ.N    ??SPIFFS_open_by_page_5
        LDR.W    R0,??DataTable16_2  ;; 0xffffd8eb
        CMP      R8,R0
        BEQ.N    ??SPIFFS_open_by_page_5
        LDR.W    R0,??DataTable16_3  ;; 0xffffd8ea
        CMP      R8,R0
        BEQ.N    ??SPIFFS_open_by_page_5
        LDR.W    R0,??DataTable16_4  ;; 0xffffd8e3
        CMP      R8,R0
...
??SPIFFS_read_5:
        ...
        LSLS     R0,R0,#+28
        BMI.N    ??SPIFFS_read_6
        LDR.W    R0,??DataTable18  ;; 0xffffd8da
        MOV      R8,R0
        CMP      R8,#+0
        BPL.N    ??SPIFFS_read_6
        STR      R8,[R4, #+52]
...
??SPIFFS_read_6:
        ...
        CMP      R7,#+1
        BLT.N    ??SPIFFS_read_7
        LDR.W    R0,??DataTable19  ;; 0xffffd8ed
        MOV      R8,R0
        CMP      R8,#+0
        BPL.N    ??SPIFFS_read_7
        STR      R8,[R4, #+52]
...
??spiffs_hydro_write_2:
        ...
        MOV      R9,R0
        CMP      R9,#+0
        BPL.N    ??spiffs_hydro_write_3
        MOV      R0,R9
        B.N      ??spiffs_hydro_write_4
...
??SPIFFS_write_5:
        ...
        LDR.W    R0,??DataTable23  ;; 0xffffd8db
        MOV      R9,R0
        CMP      R9,#+0
...
SPIFFS_lseek:
        ...
        MOVS     R7,R3
        LDR      R0,[R4, #+108]
        LDR.N    R1,??DataTable9  ;; 0x20090315
        CMP      R0,R1
        BEQ.N    ??SPIFFS_lseek_0
        LDR.N    R0,??DataTable9_1  ;; 0xffffd8d8
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable9_1  ;; 0xffffd8d8
        B.N      ??SPIFFS_lseek_1
??SPIFFS_lseek_0:
        ...
        LDR.N    R0,??DataTable11  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable11  ;; 0xffffd8f0
        B.N      ??SPIFFS_lseek_1
??SPIFFS_lseek_2:
...
SPIFFS_remove:
        ...
        MOVS     R5,R1
        LDR      R0,[R4, #+108]
        LDR.W    R1,??DataTable28  ;; 0x20090315
        CMP      R0,R1
        BEQ.N    ??SPIFFS_remove_0
        LDR.W    R0,??DataTable29  ;; 0xffffd8d8
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable29  ;; 0xffffd8d8
        B.N      ??SPIFFS_remove_1
??SPIFFS_remove_0:
...
??SPIFFS_remove_2:
        ...
        LDR.N    R0,??DataTable12  ;; 0xffffd8cc
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable12  ;; 0xffffd8cc
        B.N      ??SPIFFS_remove_1
??SPIFFS_remove_3:
...
??SPIFFS_stat_0:
        ...
        CMP      R0,#+0
        BNE.N    ??SPIFFS_stat_2
        LDR.W    R0,??DataTable32  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable32  ;; 0xffffd8f0
        B.N      ??SPIFFS_stat_1
??SPIFFS_stat_2:
...
??SPIFFS_fflush_0:
        ...
        LDR.W    R0,??DataTable34  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable34  ;; 0xffffd8f0
        B.N      ??SPIFFS_fflush_1
??SPIFFS_fflush_2:
...
??SPIFFS_rename_3:
        LDR.W    R0,??DataTable34_1  ;; 0xffffd8cc
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable34_1  ;; 0xffffd8cc
        B.N      ??SPIFFS_rename_1
??SPIFFS_rename_4:
...
??SPIFFS_rename_5:
        ...
        BL       spiffs_object_find_object_index_header_by_name
        MOVS     R7,R0
        LDR.W    R0,??DataTable34_2  ;; 0xffffd8ee
        CMP      R7,R0
...
??SPIFFS_rename_6:
        ...
        LDR.W    R0,??DataTable34_3  ;; 0xffffd8d9
        MOVS     R7,R0
??SPIFFS_rename_7:
        CMP      R7,#+0
...
??SPIFFS_fupdate_meta_5:
        ...
        LDR.N    R0,??DataTable23  ;; 0xffffd8db
        MOVS     R7,R0
        CMP      R7,#+0
...
SPIFFS_opendir:
        ...
        MOVS     R3,R0
        LDR      R0,[R3, #+108]
        LDR.W    R4,??DataTable28  ;; 0x20090315
        CMP      R0,R4
...
SPIFFS_closedir:
        ...
        LDR      R0,[R1, #+0]
        LDR      R0,[R0, #+108]
        LDR.N    R2,??DataTable28  ;; 0x20090315
        CMP      R0,R2
        BEQ.N    ??SPIFFS_closedir_0
        LDR.N    R0,??DataTable29  ;; 0xffffd8d8
        LDR      R2,[R1, #+0]
        STR      R0,[R2, #+52]
        LDR.N    R0,??DataTable29  ;; 0xffffd8d8
...
SPIFFS_check:
        ...
        MOVS     R4,R0
        LDR      R0,[R4, #+108]
        LDR.N    R1,??DataTable28  ;; 0x20090315
        CMP      R0,R1
...
SPIFFS_info:
        ...
        MOVS     R4,#+0
        LDR      R0,[R3, #+108]
        LDR.N    R5,??DataTable28  ;; 0x20090315
        CMP      R0,R5
        BEQ.N    ??SPIFFS_info_0
        LDR.N    R0,??DataTable29  ;; 0xffffd8d8
        STR      R0,[R3, #+52]
...
SPIFFS_ix_map:
        ...
        LDR      R8,[SP, #+44]
        LDR      R0,[R4, #+108]
        LDR.W    R1,??DataTable34_11  ;; 0x20090315
        CMP      R0,R1
...
??SPIFFS_ix_map_0:
        ...
        LDR.N    R0,??DataTable32  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable32  ;; 0xffffd8f0
        B.N      ??SPIFFS_ix_map_1
??SPIFFS_ix_map_2:
...
??SPIFFS_ix_map_5:
        ...
        LDR.W    R0,??DataTable34_12  ;; 0xffffd8ca
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable34_12  ;; 0xffffd8ca
        B.N      ??SPIFFS_ix_map_1
??SPIFFS_ix_map_6:
...
SPIFFS_ix_unmap:
        ...
        LDR.W    R0,??DataTable34_13  ;; 0xffffd8d8
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable34_13  ;; 0xffffd8d8
...
??SPIFFS_ix_unmap_5:
        ...
        LDR.W    R0,??DataTable34_14  ;; 0xffffd8cb
        STR      R0,[R4, #+52]
        LDR.W    R0,??DataTable34_14  ;; 0xffffd8cb
        B.N      ??SPIFFS_ix_unmap_1
??SPIFFS_ix_unmap_6:
...
??SPIFFS_ix_remap_5:
        ...
        LDR.N    R0,??DataTable34_14  ;; 0xffffd8cb
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable34_14  ;; 0xffffd8cb
        B.N      ??SPIFFS_ix_remap_1
??SPIFFS_ix_remap_6:
...
SPIFFS_bytes_to_ix_map_entries:
        MOVS     R2,R0
        LDR      R0,[R2, #+108]
        LDR.N    R3,??DataTable34_11  ;; 0x20090315
        CMP      R0,R3
        BEQ.N    ??SPIFFS_bytes_to_ix_map_entries_0
        LDR.N    R0,??DataTable34_13  ;; 0xffffd8d8
        STR      R0,[R2, #+52]
        LDR.N    R0,??DataTable34_13  ;; 0xffffd8d8
...
SPIFFS_vis:
        ...
        MOVS     R5,#+0
        LDR      R0,[R4, #+108]
        LDR.N    R1,??DataTable34_11  ;; 0x20090315
        CMP      R0,R1
        BEQ.N    ??SPIFFS_vis_0
        LDR.N    R0,??DataTable34_13  ;; 0xffffd8d8
        STR      R0,[R4, #+52]
...
??SPIFFS_vis_0:
        ...
        CMP      R0,#+0
        BNE.N    ??SPIFFS_vis_2
        LDR.N    R0,??DataTable34  ;; 0xffffd8f0
        STR      R0,[R4, #+52]
        LDR.N    R0,??DataTable34  ;; 0xffffd8f0
        B.N      ??SPIFFS_vis_1
??SPIFFS_vis_2:
...
??SPIFFS_vis_13:
        ...
        B.N      ??SPIFFS_vis_12
??SPIFFS_vis_14:
        ADR.N    R0,??DataTable34_7  ;; "d"
        BL       printf
??SPIFFS_vis_12:
        ADDS     R9,R9,#+1
        TST      R9,#0x3F
        BNE.N    ??SPIFFS_vis_7
        ADR.N    R0,??DataTable34_8  ;; "\n"
        BL       printf
        B.N      ??SPIFFS_vis_7
??SPIFFS_vis_8:
        ADDS     R8,R8,#+1
...
// 7 356 bytes in section .text
// 
// 7 356 bytes of CODE  memory
